...
//                   </div>
//                   <div className="mail-action-icons" style={{visibility: 'visible', opacity: 1}}>
//                     <button
...
//                 <div className="mail-info-footer d-flex flex-wrap gap-2 align-items-center justify-content-between p-3 border-top" style={{visibility: 'visible', opacity: 1}}>
//                   <div>
//                     <button className="btn btn-icon btn-primary-light" title="Print" style={{visibility: 'visible', opacity: 1}}>
//                       <i className="ri-printer-line"></i>
//                     </button>
//                     <button className="btn btn-icon btn-secondary-light ms-1" title="Mark as read" style={{visibility: 'visible', opacity: 1}}>
//                       <i className="ri-mail-open-line"></i>
//                     </button>
//                     <button className="btn btn-icon btn-success-light ms-1" title="Reload" style={{visibility: 'visible', opacity: 1}}>
//                       <i className="ri-refresh-line"></i>
//                     </button>
//                   </div>
//                   <div>
//                     <button className="btn btn-secondary" style={{visibility: 'visible', opacity: 1}}>
//                       <i className="ri-share-forward-line me-1 d-inline-block align-middle"></i>Forward
//                     </button>
//                     <button className="btn btn-primary ms-1" style={{visibility: 'visible', opacity: 1}}>
