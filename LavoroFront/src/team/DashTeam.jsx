    ...
    const fetchData = async () => {
      try {
        ...
        const [projectCountRes, archiveRes, statusRes, teamStatsRes, membersRes, nbrProjectsRes, teamsRes] = await Promise.all([
          axios.get("http://localhost:3000/project/countProject"),
          axios.get("http://localhost:3000/project/countArchive"),
          axios.get("http://localhost:3000/project/projetStatus"),
          axios.get("http://localhost:3000/teams/getTeamStat"),
          axios.get(`http://localhost:3000/teams/getTeamMember?page=${pagination.page}&limit=${pagination.limit}&role=Developer`),
          axios.get("http://localhost:3000/teams/nbrProject"),
          axios.get("http://localhost:3000/teams/getAllTeams")
        ]);
    ...
    <>
      ...
      <div className="d-flex align-items-center justify-content-between page-header-breadcrumb flex-wrap gap-2">
        <div>
          ...
          <h1 className="page-title fw-medium fs-18 mb-0">Projects & Teams Dashboard</h1>
        </div>
              ...
              <div className="card custom-card overflow-hidden main-content-card">
                <div className="card-body">
                  ...
                  <div className="text-muted fs-13">
                    Projects managed by team managers
                  </div>
                </div>
              </div>
            </div>
