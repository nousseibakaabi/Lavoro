...
const ArchivedTeamDetails = () => {
  ...
  useEffect(() => {
    const fetchArchivedTeam = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:3000/teams/archived-team/${id}`, {
          headers: {
  ...
  const handleUnarchive = async () => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:3000/teams/${id}/unarchive`, {}, {
        headers: {
          'Authorization': `Bearer ${token}`,
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`http://localhost:3000/teams/archived-teams/${id}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        },
